...
class Servo:
    ...
    @staticmethod
    def servo_remap(x, in_min, in_max, out_min, out_max):
    ...
    def goto_angle(self, angle):
        ...
        if angle > 180:
            angle = 180
        self._goto(round(self.servo_remap(angle, 0, 180, 0, 1024))) # Convert range value to angle value
